output "topic_arn" {
  ...
  value       = "${module.example_topic_arn.arn}"
}

output "iam_name" {
  description = "Name of IAM user that has been created"
  value       = "${module.example_topic_iam.name}"
}

output "iam_arn" {
  description = "ARN of IAM user that has been created"
  value       = "${module.example_topic_iam.arn}"
}
...
output "iam_access_key_id" {
  ...
  value       = "${module.example_iam_access_key.id}"
}

output "iam_access_key_secret" {
  description = "The secret access key ID"
  value       = "${module.example_iam_access_key.secret}"
}
